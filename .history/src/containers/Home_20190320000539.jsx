...
class Home extends Component {
  ...
  componentDidMount() {
    ...
    const firstList = getSearchResult(shaffleList.slice(0, 1), 50);
    this.setState({ shaffleList: shaffleList, recommendList: firstList });
  }
  ...
  render() {
    return (
      <div>
        ...
        <VideoSlick title={shaffleList.slice(0, 11)} recommendList={this.state.recommendList} />
