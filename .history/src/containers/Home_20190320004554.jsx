...
class Home extends Component {
  ...
  componentDidMount() {
    ...
    Promise.all([getSearchResult(shaffleList.slice(0, 1), 50)]).then(recommendList => {
  ...
  render() {
    return (
      <div>
        ...
        <VideoSlick title={this.state.shaffleList.slice(0, 1)} recommendList={this.state.recommendList[0]} />
