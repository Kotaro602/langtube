...
const firstList = await getSearchResult(shuffle(category).slice(0, 1), 50)
    this.setState({ buttonList: shuffle(category).slice(4, 12) });
  }
  ...
  render() {
    return (
      <div>
        ...
        {/* <VideoSlick searchWord={this.state.shaffleList.slice(9, 10)} />
