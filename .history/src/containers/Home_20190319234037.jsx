...
class Home extends Component {
  ...
  componentDidMount() {
    this.setState({ showSearchList: shuffle(category).slice(0, 8) });
  }
  ...
  render() {
    return (
      <div>
        ...
        <VideoSlick searchWord={this.state.showSearchList.slice(9, 10)} />
        <VideoSlick searchWord={this.state.showSearchList.slice(10, 11)} />
        <VideoSlick searchWord={this.state.showSearchList.slice(11, 12)} />
      </div>
    );
  }
}
