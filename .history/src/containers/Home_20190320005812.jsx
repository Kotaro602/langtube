...
class Home extends Component {
  ...
  componentDidMount() {
    ...
    Promise.all([getSearchResult(shaffleList.slice(0, 1)[0], 50),getSearchResult(shaffleList.slice(0, 1)[0], 50)],getSearchResult(shaffleList.slice(0, 1)[0], 50)]]).then(recommendList => {
