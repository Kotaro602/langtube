...
export function getVideoInfo(videoId) {
    ...
    return fetch(youtubeUrls.videoUrl + query).then(res => res.json());
}
...
export function getRelatedVideo(categoryId, resultCount) {
    ...
    return fetch(youtubeUrls.searchUrl + query).then(res => res.json());
}
...
export async function getSubtitle(videoId, langage) {
    ...
    const listRes = await fetch(youtubeUrls.subtitleUrl + listQuery);
...
async function getClosedCaption(videoId, subtitleInfo) {
    ...
    let closedCapRes = await fetch(youtubeUrls.subtitleUrl + closedCapQuery)
