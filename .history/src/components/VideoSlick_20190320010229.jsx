...
class VideoSlick extends Component {
  ...
  render() {
    ...
    if(this.props.recommendList.items) const recList = shuffle(this.props.recommendList.items)
    ...
    return (
      <Card className={css(styles.sliderBox)}>
        <div>
          ...
          <Slider {...settings}>
            {this.props.recommendList.items &&
              this.props.recommendList.items.map((item, i) => {
                return (
